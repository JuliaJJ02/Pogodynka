...
class HourlyForecastView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final hourlyWeatherData = ref.watch(hourlyForecastProvider);
    ...
    return hourlyWeatherData.when(
        data: (hourlyWeather) {
          ...
          {
            //1st get my hourly weather, then return hourly weather tile
...
class HourlyForecastTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      ///material widget is similar to container
      child: Material(
