//specified all variables that are coming from openweathermap
...
@immutable
//coord - this is location Latitude & Longitude
class Coord {
  final double lon;
  final double lat;
  ...
  //how to take this data from json
...
//weather is a list of id, main, desc,icon
@immutable
class WeatherData {
  final int id;
  final String main;
